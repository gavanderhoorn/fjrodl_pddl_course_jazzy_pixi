...
Follow the Linux instructions, but use `pixi run fetch_osx64` instead of the regular `fetch` task.
...
The `fetch_osx64` task also retrieves the `popf` and `PlanSys2` sources.
